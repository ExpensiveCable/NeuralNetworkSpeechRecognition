...
const String words[NUMBER_OF_LABELS] = {"OK", "Yes", "No"};  // words for each label
...
#define N_INPUTS FEATURE_SIZE
#define N_OUTPUTS NUMBER_OF_LABELS
...
void loop() {
  ...
  tf.predict(feature_data, prediction);
